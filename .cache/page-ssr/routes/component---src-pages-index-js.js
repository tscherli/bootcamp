...
function useCommittedRef_useCommittedRef(value) {
  var ref = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(value);
  (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useEffect)(function () {
    ref.current = value;
  }, [value]);
  return ref;
}
...
function useEventCallback_useEventCallback(fn) {
  ...
  return (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(function () {
...
function useUpdateEffect(fn, deps) {
  var isFirst = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(true);
  (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useEffect)(function () {
    if (isFirst.current) {
...
function useMounted() {
  var mounted = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(true);
  var isMounted = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(function () {
...
function useUpdatedRef(value) {
  var valueRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(value);
...
function useTimeout() {
  ...
  var handleRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)();
  useWillUnmount(function () {
    return clearTimeout(handleRef.current);
  });
  return (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useMemo)(function () {
...
/* harmony default export */ const useIsomorphicEffect = (isDOM || isReactNative ? external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useLayoutEffect : external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useEffect);
...
const Button = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
  } = _ref,
 ...
 */
const Anchor = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.forwardRef((_ref, ref) => {
  let {
    onKeyDown
  } = _ref,
...
function useUncontrolledProp(propValue, defaultValue, handler) {
  var wasPropRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(propValue !== undefined);

  var _useState = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useState)(defaultValue),
  ...
  return [isProp ? propValue : stateValue, (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(function (value) {
...
const ThemeContext = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.createContext({
  prefixes: {}
});
const {
  Consumer,
...
function useBootstrapPrefix(prefix, defaultPrefix) {
  const {
    prefixes
  } = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useContext)(ThemeContext);
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.forwardRef(({
    className,
    bsPrefix,
...
const CarouselItem = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.forwardRef(({
...
function map(children, func) {
  let index = 0;
  return external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.Children.map(children, child => /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.isValidElement(child) ? func(child, index++) : child);
}
/**
...
function forEach(children, func) {
  let index = 0;
  external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.Children.forEach(children, child => {
    if ( /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.isValidElement(child)) func(child, index++);
  });
}
/**
...
/* harmony default export */ const esm_css = (style);
...
/* harmony default export */ const TransitionGroupContext = (external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().createContext(null));
...
var Transition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().createElement(TransitionGroupContext.Provider, {
        value: null
      }, typeof children === 'function' ? children(status, childProps) : external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().cloneElement(external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().Children.only(children), childProps))
    );
  };
...
const TransitionWrapper = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const nodeRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(null);
  ...
  const handleEnter = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(normalize(addEndListener), [addEndListener]);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(esm_Transition, {
    ...
    children: typeof children === 'function' ? (status, innerProps) => children(status, { ...innerProps,
      ref: attachRef
    }) : /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_default().cloneElement(children, {
      ref: attachRef
    })
  });
});
...
const Carousel = /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.forwardRef((uncontrolledProps, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component = 'div',
    bsPrefix,
  ...
  const nextDirectionRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(null);
  const [direction, setDirection] = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useState)('next');
  const [paused, setPaused] = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useState)(false);
  const [isSliding, setIsSliding] = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useState)(activeIndex || 0);
  ...
  (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useEffect)(() => {
    if (nextDirectionRef.current) {
  ...
  const prev = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
    if (isSliding) {
      return;
    }
  ...
  const next = useEventCallback_useEventCallback(event => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)();
  (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useImperativeHandle)(ref, () => ({
    element: elementRef.current,
    prev,
    next
  })); // This is used in the setInterval, so it should not invalidate.

  const nextWhenVisible = useEventCallback_useEventCallback(() => {
  ...
  const handleEnter = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(node => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  }, [onSlid, renderedActiveIndex, slideDirection]);
  const handleKeyDown = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
  ...
  const handleMouseOver = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
    if (pause === 'hover') {
      setPaused(true);
    }
  ...
  const handleMouseOut = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(0);
  const touchDeltaXRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
  ...
  const handleTouchMove = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
  ...
  const handleTouchEnd = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useCallback)(event => {
    if (touch) {
  ...
  const intervalHandleRef = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useRef)();
  (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useEffect)(() => {
  ...
  const indicatorOnClicks = (0,external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => event => {
    ...
    children: [indicators && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? /*#__PURE__*/(0,jsx_runtime.jsx)(esm_TransitionWrapper, {
          ...
          children: (status, innerProps) => /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.cloneElement(child, { ...innerProps,
        ...
        }) : /*#__PURE__*/external_C_Users_TSCHERLI_bootcamp_node_modules_react_index_js_.cloneElement(child, {
...
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}injectGlobal( true?{name:"1ght4w7",styles:"*{overflow:hidden;}"}:0);function Index(){return (0,emotion_react_esm/* jsx */.tZ)("body",null,(0,emotion_react_esm/* jsx */.tZ)(Helmet.Helmet,null,(0,emotion_react_esm/* jsx */.tZ)("title",null,"Code Bootcamp"),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"description",content:"This is a Frontendmentor challenge"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"referrer",content:"origin"}),(0,emotion_react_esm/* jsx */.tZ)("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"})),(0,emotion_react_esm/* jsx */.tZ)(esm_Carousel,null,(0,emotion_react_esm/* jsx */.tZ)(esm_Carousel.Item,null,(0,emotion_react_esm/* jsx */.tZ)("div",{className:"tanya"}),(0,emotion_react_esm/* jsx */.tZ)(esm_Carousel.Caption,null,(0,emotion_react_esm/* jsx */.tZ)("div",{className:"maintext"},"\u201C I\u2019ve been interested in coding for a while but never taken the jump, until now. I couldn\u2019t recommend this course enough. I\u2019m now in the job of my dreams and so excited about the future. \u201D ",(0,emotion_react_esm/* jsx */.tZ)("span",{className:"nameofperson"},"Tanya Sinclair "),(0,emotion_react_esm/* jsx */.tZ)("span",{className:"occupation"},"UX Engineer")))),(0,emotion_react_esm/* jsx */.tZ)(esm_Carousel.Item,null,(0,emotion_react_esm/* jsx */.tZ)("div",{className:"john"}),(0,emotion_react_esm/* jsx */.tZ)(esm_Carousel.Caption,null,(0,emotion_react_esm/* jsx */.tZ)("div",{className:"maintext"},"\u201C If you want to lay the best foundation possible I\u2019d recommend taking this course. The depth the instructors go into is incredible. I now feel so confident about starting up as a professional developer. \u201D ",(0,emotion_react_esm/* jsx */.tZ)("span",{className:"nameofperson"},"John Tarkpor "),(0,emotion_react_esm/* jsx */.tZ)("span",{className:"occupation"},"Junior Front-end Developer"))))));}
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(7021),g=60103;exports.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h=Symbol.for;g=h("react.element");exports.Fragment=h("react.fragment")}var m=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n=Object.prototype.hasOwnProperty,p={key:!0,ref:!0,__self:!0,__source:!0};
